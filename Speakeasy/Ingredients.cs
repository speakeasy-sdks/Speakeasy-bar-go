...
namespace Speakeasy
{
    ...
    /// </summary>
    public interface IIngredientsSDK
    {
    ...
    /// The ingredients endpoints.
    /// </summary>
    public class IngredientsSDK: IIngredientsSDK
    {
        ...
        public IngredientsSDK(ISpeakeasyHttpClient defaultClient, ISpeakeasyHttpClient securityClient, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<ListIngredientsResponse> ListIngredientsAsync(ListIngredientsRequest? request = null)
        {
            ...
            if((response.StatusCode == 200))
            {
                ...
                {
                    response.Ingredients = JsonConvert.DeserializeObject<List<Ingredient>>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumSerializer() }});
                }
