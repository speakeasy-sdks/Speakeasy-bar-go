...
namespace Speakeasy.Bar
{
    ...
    public class Speakeasy: ISpeakeasy
    {
        ...
        private const string _sdkGenVersion = "2.258.2";
        private const string _openapiDocVersion = "1.0.0";
        private const string _userAgent = "speakeasy-sdk/csharp 0.0.1 2.258.2 1.0.0 Speakeasy.Bar";
        ...
        public Speakeasy(string? apiKey = null, Func<string>? apiKeySource = null, string? server = null, ServerEnvironment? environment = null, string?  organization = null, string? serverUrl = null, Dictionary<string, string>? urlParams = null, ISpeakeasyHttpClient? client = null)
        {
