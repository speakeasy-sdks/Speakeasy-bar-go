...
namespace Speakeasy.Bar
{
    ...
    public class Speakeasy: ISpeakeasy
    {
        ...
        private const string _userAgent = "speakeasy-sdk/csharp 0.1.0 2.248.6 1.0.0 Speakeasy.Bar";
        ...
        public Speakeasy(string? apiKey = null, string? server = null, ServerEnvironment? environment = null, string?  organization = null, string? serverUrl = null, Dictionary<string, string>? urlParams = null, ISpeakeasyHttpClient? client = null)
        {
            ...
            if( apiKey != null)
            {
                _securityClient = SecuritySerializer.Apply(_defaultClient, new Security() { ApiKey = apiKey });
            }
