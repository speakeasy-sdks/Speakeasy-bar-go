    ...
    public class Ingredients: IIngredients
    {
        ...
        public async Task<ListIngredientsResponse> ListIngredientsAsync(ListIngredientsRequest request)
        {
            ...
            if((response.StatusCode == 200))
            {
                ...
                {
                    response.Classes = JsonConvert.DeserializeObject<List<Ingredient>>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumConverter(), new AnyDeserializer() }});
                }
