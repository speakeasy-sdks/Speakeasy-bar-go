    ...
    public class Authentication: IAuthentication
    {
        ...
        public async Task<AuthenticateResponse> AuthenticateAsync(AuthenticateRequestBody request)
        {
            ...
            if((response.StatusCode == 200))
            {
                ...
                {
                    response.Object = JsonConvert.DeserializeObject<AuthenticateResponseBody>(await httpResponse.Content.ReadAsStringAsync(), new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = new JsonConverter[] { new FlexibleObjectDeserializer(), new EnumConverter(), new AnyDeserializer() }});
                }
